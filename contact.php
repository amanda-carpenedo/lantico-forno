...
<body class="home page-template page-template-template-home page-template-template-home-php page page-id-7">
    <div class="animsition global-wrapper">
        ...
        <div class="container-wrapper">
            <div class="page-bg" style=" background-image: url(img-pizza/messicana.jpg); "></div>
                    ...
                    <div class="contact-info-wrapper">
                        <div class="contact-details">
                            <div class="contact-detail contact-detail1">
                                <div class="contact-detail-title">indirizzo</div>
                                <div class="contact-detail-content">
                                    <p>3021 Piazza Cavour<br /> Torino, 11230, IT</p>
                                </div>
                            </div>
                            <div class="contact-detail contact-detail2">
                                <div class="contact-detail-title">Chiama o scrive</div>
                                <div class="contact-detail-content">
                                    <p><strong>Telefono/ </strong>00386 40 868 300<br />
                                        <strong>Email / </strong>info@somedomain.com</p>
                                </div>
                            </div>
                            <div class="contact-detail contact-detail3">
                                <div class="contact-detail-title">Orario di apertura</div>
                                <div class="contact-detail-content">
                                    <p><strong>Lunedì – Venerdì / </strong>8am – 11pm<br />
                                        <strong>Sabato / </strong>8am – 1am<br />
                            ...
                            <div role="form" class="wpcf7" id="wpcf7-f49-p15-o1" lang="en-US" dir="ltr">
                                ...
                                <form id="contact-form" action="#">
                                    <div class="albertos-contact-form">
                                        ...
                                        <div class="clear"></div>
                                        <div class="contact-submit"><input type="submit" value="Invia" class="wpcf7-form-control wpcf7-submit"  id="submit_contact" /><div id="msg" class="message"></div></div>
                                    </div>
                                </form>
                            </div>
                        </div>
