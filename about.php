...
<body class="home page-template page-template-template-home page-template-template-home-php page page-id-7">
    <div class="animsition global-wrapper">
        ...
        <div class="mobile-menu-wrapper">
            <div class="menu-main-nav-menu-container">
                <ul id="menu-main-nav-menu-1" class="mobile-menu">
                    ...
                    <li class="menu-item  current-menu-items current_page_item"><a href="about.html">About us</a></li>
        ...
        <div class="container-wrapper">
            <div class="page-bg" style=" background-image: url(img-pizza/margherita.jpg); "></div>
            <div id="container">
                <!-- start container -->
                ...
                <div class="page-wrapper">
                    <h1>Scegliamo solo ingredienti freschi.<br /> Perchè lo facciamo?</h1>
                    <p>La qualità nasce dalla tradizione. Selezioniamo con cura ogni ingrediente, scegliendo solo materie prime freschissime e locali. Dalla farina macinata a pietra al pomodoro maturato al sole, ogni sapore è un omaggio alla genuinità, per portarvi in tavola una pizza autentica e indimenticabile.</p>
                    <p><img class="aligncenter size-full wp-image-63" src="img-pizza/tecnica.jpg" alt="" width="550" height="400" /></p>
                    <h1>Il nostro staff</h1>
                    <p>Il nostro staff è composto da professionisti appassionati e qualificati, dediti all'arte della vera pizza italiana. Ogni membro del team porta con sé anni di esperienza e una profonda conoscenza delle materie prime, lavorando con precisione e armonia per garantirvi un’esperienza culinaria d’eccellenza.</p>
                    <p>&nbsp;</p>
                    <p><img class="aligncenter size-full wp-image-65" src="img-pizza/staff.jpg" alt="" width="550" height="400" /></p>
                    <div class="clear"></div>
                </div>
                <!-- end page wrapper -->
            </div>
