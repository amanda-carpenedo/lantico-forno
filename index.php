        ...
        <div class="container-wrapper">
            <div id="rev_slider_1_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-source="gallery" style="background-color:transparent;padding:0px;">
                ...
                <div id="rev_slider_1_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.3.1.5">
                    <ul>
                        <?php
                        $qgallery = "SELECT * FROM gallery WHERE status = 1";
                        $rgallery = mysqli_query($conn, $qgallery);
                        $x = 1;
                        while ($gallery = mysqli_fetch_assoc($rgallery)) {

                        ?>
                            <li data-index="rs-<?php echo $x; ?>" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="upload/slide4-100x50.jpg" data-rotate="0" data-saveperformance="off" data-title="<?php echo $gallery['title']; ?>" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                <!-- MAIN IMAGE -->
                                <img src="img-pizza/<?php echo $gallery['img'] ?>" alt="" title="<?php echo $gallery['title']; ?>" width="2560" height="1440" data-bgposition="center center" data-kenburns="on" data-duration="10000" data-ease="Back.easeOut" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" class="rev-slidebg" data-no-retina>
                                <!-- LAYERS -->
                            </li>
