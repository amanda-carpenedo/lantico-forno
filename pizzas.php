        ...
        <div class="mobile-menu-wrapper">
            <div class="menu-main-nav-menu-container">
                <ul id="menu-main-nav-menu-1" class="mobile-menu">
                    ...
                    <li class="menu-item current-menu-items current_page_item"><a href="pizzas.php">Pizzas</a></li>
                ...
                <div class="page-wrapper">
                    <div class="offer-menu2-wrapper">
                        <div class="offer-menu2-items">
                                ...
                                <?php
                                $q_pizza = "SELECT * FROM pizza";
                                $r_pizza = mysqli_query($conn, $q_pizza);

                                while($pizza = mysqli_fetch_assoc($r_pizza)){
                                ...
                                <div class="offer-menu2-item-single">
                                    ...
                                    <div class="offer-menu2-thumb-image"><img src="img-pizza/<?php echo $pizza['img']; ?>" width="313" height="220" alt="<?php echo $pizza['nome']; ?>" /></div>
                                    <div class="clear"></div>
                                    <span class="offer-menu2-icon flaticon-pizza-slice"></span>
                                    <div class="offer-menu2-details">
                                        <div class="single-offer-menu2-title"><?php echo $pizza['nome']; ?></div>
                                        ...
                                        <div class="single-offer-menu2-price">&euro; <?php echo number_format($pizza['prezzo'], 2, ','); ?></div>
                                    </div>
                                </div>
